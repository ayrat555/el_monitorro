...
static START: &str =
        "El Monitorro is feed reader as a Telegram bot.\n\
         ...
         Unlike other similar projects, El Monitorro is completely open and it's free of charge. I develop it in my free time and pay for hosting myself. Please support the bot by donating - https://paypal.me/ayrat555";
